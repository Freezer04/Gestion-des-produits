                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputPasswordConfirm" type="number" name="phone" placeholder="Enter your number phone " required />
                                                        <label for="inputPasswordConfirm">Phone</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button name="submit" class="btn btn-md  btn-primary">Create a Acounte</button></div>
                                            </div>
                                        </form>
                                    </div>
